          ...
          {selectedTab === 'safety-score' && (
            <div className="text-center">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-r from-blue-500 to-green-500 p-8 rounded-2xl text-white mb-8">
                  <div className="text-6xl font-bold mb-4">4.8</div>
                  ...
                  <p className="text-xl">Your Current Safety Score</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white dark:bg-gray-700 p-6 rounded-xl">
                    ...
                    <ul className="text-gray-600 dark:text-gray-300 space-y-1">
                      <li>Travel history: 95%</li>
                      <li>Emergency contacts: 100%</li>
                      <li>Insurance: 90%</li>
            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Tourist-friendly areas with enhanced security
                  </p>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Areas requiring extra caution and awareness
                  </p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl">
                  <div className="flex items-center space-x-2 mb-3">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    High-risk areas with immediate alert protocols
                  </p>
                </div>
              </div>
            </div>
